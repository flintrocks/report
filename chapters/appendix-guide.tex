...
\begin{itemize}
	\item Literal (e.g. \mintinline{swift}{1}, \mintinline{swift}{"hello"}, \mintinline{swift}{false}, etc.) – constant value; see \hyperref[sec:appendix-b-literals]{literals}.\\
	\item Range (e.g. \mintinline{swift}{<expr-1>..<<expr-2>}, \mintinline{swift}{<expr-1>...<expr-2>}) – see \hyperref[sec:appendix-b-range-types]{ranges}.\\
	\item Binary expression (e.g. \mintinline{swift}{<expr-1> <op> <expr-2>}) – a binary operation \mintinline{swift}{<op>} applied to the expressions \mintinline{swift}{<expr-1>} and \mintinline{swift}{<expr-2>}; see \hyperref[sec:appendix-b-operators]{operators}.\\
	\item Struct reference (e.g. \mintinline{swift}{&<expr>}) – see \hyperref[sec:appendix-b-structs-as-function-arguments]{structs as function arguments}.\\
	\item Function call (e.g.\\\mintinline{swift}{<function-name>(<param-1>: <expr-1>, <param-2>: <expr-2>, ...)})\\– call to the function \mintinline{swift}{<function-name>} with the results of the given expressions \mintinline{swift}{<expr-1,2,...>} as parameters. See \hyperref[sec:appendix-b-function-calls]{function calls}.\\
	\item Dot access (e.g. \mintinline{swift}{<expr-1>.<field>}) - access to the \mintinline{swift}{<field>} field (variable, constant, function) or the result of \mintinline{swift}{<expr-1>}.\\
	\item Index / key access (e.g. \mintinline{swift}{<expr-1>[<expr-2>]}) – access to the given key of a list or dictionary.\\
	\item External call (e.g.\\\mintinline{swift}{call <external-contract>.<function-name>(<param-1>: <expr-1>, ...)})\\– call to the function of an external contract; see \hyperref[sec:appendix-b-external-calls]{external calls}.\\
	\item Type cast (e.g. \mintinline{swift}{<expr> as! <type>}) – forced cast of the result of \mintinline{swift}{<expr>} to \mintinline{swift}{<type>}; see \hyperref[sec:appendix-b-casting-to-and-from-solidity-types]{casting to and from Solidity types}.\\
	\item Attempt (e.g. \mintinline{swift}{try? <call>}, \mintinline{swift}{try! <call>}) – attempt to call a function in a different protection block, see \hyperref[sec:appendix-b-dynamic-checking]{dynamic checking}.
\end{itemize}
